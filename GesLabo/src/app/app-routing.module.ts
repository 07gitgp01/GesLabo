...
import { PageNotFoundComponent } from './features/admin/components/page-not-found/page-not-found.component';
...
{ path: "", component: AdminComponent, children: [
  {
    path: "", children: [
      ...
      { path: "", loadChildren:() => import ('./features/admin/components/reservations/reservations.module').then(m => m.ReservationsModule)},
